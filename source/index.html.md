...
type | (Required) Type of virtual machines to create: `1cpu`, `2cpu`, or `4cpu`
...
image |  `10.15`, `10.14`, `10.13`, `10.12`, `10.11`, `10.10`, `10.9`, or `latest`. If not specified, defaults to `latest`, which is currently `10.15`
